...
N = 10
prompt = f'Give me {N} reformulations (without ever repeating yourself) of the following instruction: "{original_prompt}"'
...
out = model(prompt, max_new_tokens=4096, do_sample=False, batch_size=1)
print(out)
prompts = out.split('\n\n')
