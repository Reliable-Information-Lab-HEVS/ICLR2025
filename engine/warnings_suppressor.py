...
def swallow_bitsandbytes_prints():
    ...
    Note: Since bitsandbytes version 0.41, this is not necessary anymore as the prints were removed (they
    commented the responsible line, see https://github.com/TimDettmers/bitsandbytes/blob/0.41.0/bitsandbytes/cextension.py#L42)
    """
