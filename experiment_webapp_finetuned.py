...
from TextWiz.textwiz import HFCausalModel
from TextWiz.textwiz.templates.conversation_template import GenericConversation, CONVERSATION_MAPPING
...
def get_empty_conversation() -> GenericConversation:
    ...
    return MODEL.get_empty_conversation()
