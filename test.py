...
with torch.no_grad():
    ...
    foo = model.model(model.tokenizer.encode(prompt, return_tensors='pt').cuda(), use_cache=use_cache)
...
with torch.no_grad():
    ...
    #             use_cache=use_cache, output_attentions=output_attentions, output_hidden_states=output_hidden_states)
    foo2 = model.model(model.tokenizer.encode(prompt, return_tensors='pt').cuda(), use_cache=use_cache)
...
with torch.no_grad():
    ...
    #             use_cache=use_cache, output_attentions=output_attentions, output_hidden_states=output_hidden_states)
    foo4 = model.model(model.tokenizer.encode(prompt, return_tensors='pt').cuda(), use_cache=use_cache)
...
with torch.no_grad():
    ...
    #             use_cache=use_cache, output_attentions=output_attentions, output_hidden_states=output_hidden_states)
    foo5 = model.model(model.tokenizer.encode(new_prompt, return_tensors='pt').cuda(), use_cache=use_cache)
